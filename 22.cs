...
namespace n
{
    class Program
    {
        ...
        {
              double k,velocity1, velocity2, mass1, mass2, energy1, energy2, energy1After, energy2After;
            double velocity1After, velocity2After;

            Console.Write("Введите коэффициент восстановления:");
            ...
            velocity1After = (mass1 * velocity1 + mass2 * velocity2 - (velocity1 - velocity2) * mass2 * k) / (mass1 + mass2);
            velocity2After = (mass1 * velocity1 + mass2 * velocity2 + (velocity1 - velocity2) * mass1 * k) / (mass1 + mass2);
